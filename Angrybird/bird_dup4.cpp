...
bird_dup4::bird_dup4(float x, float y, float radius, QTimer *timer, QPixmap pixmap, b2World *world, QGraphicsScene *scene):Bird(x,y,radius,timer,pixmap,world,scene)
{
    ...
    fixturedef.density = BIRD_dup4_DENSITY;
    fixturedef.friction = BIRD_dup4_FRICTION;
    fixturedef.restitution = BIRD_dup4_RESTITUTION;
